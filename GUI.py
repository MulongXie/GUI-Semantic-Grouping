...
class GUI:
    ...
    *****************************
    ...
    def element_detection(self, is_ocr=False, is_non_text=False, is_merge=False, img_resize_longest_side=800, show=False):
        ...
        if is_merge:
            ...
            self.detect_result_img_merge, self.compos_json = merge.merge(self.img_file, compo_path, ocr_path, self.merge_dir, is_remove_bar=key_params['remove-ui-bar'], is_paragraph=True, show=show)
    ...
    *********************
    ...
    def visualize_element_detection(self, is_resize_showing=True):
        if is_resize_showing:
    ...
    def visualize_layout_recognition(self, is_resize_showing=True):
